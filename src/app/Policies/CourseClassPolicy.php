...
class CourseClassPolicy
{
    ...
    {
        return $user->can('view_any_course::class');
    }
    ...
    {
        return $user->can('view_course::class');
    }
    ...
    {
        return $user->can('create_course::class');
    }
    ...
    {
        return $user->can('update_course::class');
    }
    ...
    {
        return $user->can('delete_course::class');
    }
    ...
    {
        return $user->can('delete_any_course::class');
    }
     ...
     */
    public function replicate(User $user, CourseClass $courseClass): bool
    {
