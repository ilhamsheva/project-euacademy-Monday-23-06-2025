...
class TaskAnswerPolicy
{
    ...
    {
        return $user->can('view_any_task::answer');
    }
    ...
    {
        return $user->can('view_task::answer');
    }
    ...
    {
        return $user->can('create_task::answer');
    }
    ...
    {
        return $user->can('update_task::answer');
    }
    ...
    {
        return $user->can('delete_task::answer');
    }
    ...
    {
        return $user->can('delete_any_task::answer');
    }
     ...
     */
    public function replicate(User $user, TaskAnswer $taskAnswer): bool
    {
