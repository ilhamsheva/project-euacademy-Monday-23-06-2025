...
class ModulPolicy
{
    ...
    {
        return $user->can('view_any_modul');
    }
    ...
    {
        return $user->can('delete_any_modul');
    }
     ...
     */
    public function replicate(User $user, Modul $modul): bool
    {
